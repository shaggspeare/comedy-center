      ...
      <div className="main" data-bs-spy="scroll" data-bs-target="#navContentmenu" data-bs-root-margin="0px 0px -50%" data-bs-smooth-scroll="true">
        <div id="colorMode" className="theme-switcher d-none">
          ...
          <label htmlFor="checkbox" className="checkbox-label">
            <span className="moon-icon" data-bs-theme-value="dark"><svg width="26" height="25"><use xlinkHref="#moon-icon"></use></svg></span>
            <span className="sun-icon" data-bs-theme-value="light"><svg width="24" height="24"><use xlinkHref="#sun-icon"></use></svg></span>
