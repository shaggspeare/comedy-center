                    ...
                    <div className="row gy-lg-0 gy-50">
                        <div className="col-lg-7">
                            ...
                            <div className="mt-20 mt-md-30 mt-lg-40 mt-xxl-60">
                                <Link href="#" className="text-decoration-none display-6 custom-jakarta fw-extra-bold">contact@mail.com</Link>
                                <div className="contact-details custom-heading-color-2 mt-10 mt-lg-30">
                                    <h3 className="custom-jakarta fw-bold mb-20">BASEMENT</h3>
                                    <h3 className="custom-jakarta fw-semibold mb-5">135 W, 46nd Street, New York, USA</h3>
                                    ...
                                    <ul className="list-unstyled contact-icons d-flex align-items-center gap-20 gap-lg-30 mt-4 mt-lg-40 mb-0">
                                        ...
                                        <li><Link href="#" aria-label="icons"><SocialIcon2 height={"30"} width={"30"} /></Link></li>
                                        <li><Link href="#" aria-label="icons"><SocialIcon3 height={"26"} width={"28"} /></Link></li>
                                        <li><Link href="#" aria-label="icons"><SocialIcon4 height={"31"} width={"30"} /></Link></li>
