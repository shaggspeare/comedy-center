        ...
        <div className="row gy-4 gy-lg-0 align-items-lg-end justify-content-lg-between mb-40 mb-lg-70">
          <div className="col-lg-4">
            <div className="section-title wow fadeInRight">
              <SectionName name={'The Shop'} className={''} />
              <SectionTitleTwo
                title={'Get Our'}
          ...
          <div className="col-lg-5">
            <div className="highlights-text wow fadeInLeft">
              <SectionDesc
                desc={
                  'Elevating the Music. Our valued partners and sponsors play a pivotal role in bringing our vision to life. With their support, we orchestrate an unforgettable music celebration.'
                }
                className={
            ...
            {productData.map(({ id, img, link, name, price }) => {
              return (
                <SwiperSlide key={id} className="swiper-slide">
                  <ShopCard img={img} name={name} link={link} price={price} />
                </SwiperSlide>
              );
            })}
          </Swiper>
