                ...
                <div className="row gx-70 gy-40">
                    <div className="col-lg-4">
                        <div className="schedule-left-content wow fadeInRight">
                            ...
                            {/* -- section-title -- */}
                            <SectionDesc
                                desc={"Captivating performances, interactive workshops, and delightful culinary delights await you at Harmonia Music Festival. Let the melodies transcend boundaries on this unforgettable musical journey."}
