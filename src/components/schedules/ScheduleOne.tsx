...
const ScheduleOne: React.FC = () => {
  return (
    <section
      id="schedule"
      className="schedule-section schedule-2 py-50 py-lg-100 pt-xxl-120 position-relative"
    >
...
const SchedulePart: React.FC<SchedulePartProps> = ({
  day,
  date,
  className,
  data,
    ...
    <div className={`row gx-90 gy-40 gy-lg-0 ${className}`}>
      <div className="col-lg-4 col-xxl-3">
        <div className="schedule-date sticky-contents">
          <h2 className="fw-extra-bold text-opacity">
            <WordOpacity paragraph={day} />
          </h2>
