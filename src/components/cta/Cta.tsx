...
interface ArrowTopRightBigProps {
  iconClr?: string;
}

const Cta: React.FC<CtaProps> = ({ styleNum }) => {
          ...
          <div className="row gy-20 gy-lg-0 align-items-lg-center justify-content-lg-between">
            <div className="col-lg-4">
              <div className="d-flex justify-content-between align-items-center">
                <h2
                  className={`fs-180-style-2 fw-bold  ${numberClass} d-flex align-items-center gap-2 mb-0`}
                >
                  <SlotCounter
                    startValue={0}
                    value={30}
            ...
            <div className="col-lg-5">
              <h2
                className={`cta-text ms-xl-n60 display-3 fw-extra-bold ${textClass}`}
              >
...
const ArrowTopRightBig: React.FC<ArrowTopRightBigProps> = ({ iconClr }) => {
  return (
