            ...
            <div className="hero-wrapper mx-auto position-relative parallax">
                <div className="container">
                    <div className="hero-8-inner">
                        <h1 className="hero-heading-text fs-100 text-white text-uppercase custom-poppins mb-3 mb-xxl-20">Astral Beats on the Main Stage</h1>
