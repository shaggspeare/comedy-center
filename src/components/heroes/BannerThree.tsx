...
const BannerThree: React.FC<BannerThreeProps> = ({ subTitle }) => {
  return (
      ...
      <div className="hero-wrapper mx-auto position-relative parallax">
        ...
        <div className="social-links">
          ...
          <Link
            ...
            href="#"
          >
            <Image src={instagram} width={34} height={34} alt="img" />
            <h3 className="fw-bold custom-sans-serif">
              instagram.com/harmonia
            </h3>
          </Link>
          <Link
            className="d-flex gap-2 gap-xxl-20 align-items-center text-decoration-none"
