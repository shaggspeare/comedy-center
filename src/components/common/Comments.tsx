    ...
    <div className="blog-comments-wrapper">
      ...
      <div className="d-flex gap-3 mb-30 mb-lg-40">
        <UserProfile
          ...
          name={'Mark Petterson'}
          comment={
            'This is your chance to be part of history, to witness the magic of live music, and to create memories that will last a lifetime.'
          }
        />
      </div>
...
const UserProfile: React.FC<UserProfileProps> = ({ img, name, comment }) => {
  return (
    <>
