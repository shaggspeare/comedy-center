  ...
  return (
    <div className="blog-inner-content position-relative pt-40 pt-lg-0">
      <div className="d-flex gap-20 align-items-center">
        <a
          href="#"
          className="text-decoration-none mb-0 position-relative fw-semibold"
        >
          Artist Spotlights <span className="dot-separator"></span>
        </a>
        <p className="fw-semibold mb-0">4 min read</p>
      </div>
      <h2 className="blog-heading display-4 pt-4 pt-lg-30 pb-30 pb-lg-60 fw-extra-bold custom-jakarta mb-0">
        Unveils Star-Studded Lineup for Epic Comeback Event!
      </h2>
