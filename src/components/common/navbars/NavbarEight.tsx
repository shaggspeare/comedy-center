...
const NavbarEight: React.FC = () => {
  const pathName = usePathname();
  useStickyHeader(pathName);
  const [isDropdownOpen, setDropdownOpen] = useHoverDropdown();
  return (
    <>
      <header className="header-section header-5 position-static hover-menu">
              ...
              <div className="d-none d-xl-block">
                <div className="d-flex gap-30 align-items-center">
                  <ul className="menu-list navbar-nav mb-2 me-2 mb-lg-0">
                    ...
                    {/*                return (*/}
                    {/*                  <li key={id}><Link className="dropdown-item" href={path} target="_self" aria-label="single-pages"><span className="fw-semibold">{name}</span></Link></li>*/}
                    {/*                )*/}
                    {/*              })*/}
                    {/*            }*/}
                    {/*          </ul>*/}
