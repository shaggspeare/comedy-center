...
// Props interface for FooterThree
interface FooterThreeProps {
  styleNum?: number;
}

const FooterThree: React.FC<FooterThreeProps> = ({ styleNum }) => {
  ...
  let currentLogo: StaticImageData | string = '';
  let currentLogoDark: StaticImageData | string = '';
