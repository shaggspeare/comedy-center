...
// Props interface for FooterTwo
interface FooterTwoProps {
  styleNum?: number;
}

const FooterTwo: React.FC<FooterTwoProps> = ({ styleNum }) => {
  // styleNum 3 from home page 3 layout and home page 6 layout
  // styleNum 4 from home page 4 layout

  let currentLogo: StaticImageData | string = yellow_logo;
  let currentLogoDark: StaticImageData | string = yellow_logo_dark;
