                    ...
                    <div className="col-lg-6">
                        <div className="wow fadeInRight">
                            <div className="section-title section-title-style-2 mb-4 mb-lg-30 mb-xxl-40">
                                <h3 className="sub-title display-3 fw-extra-bold primary-text-shadow custom-roboto">Eventiva</h3>
                            </div>
                            {/* -- section-title -- */}
                            <h1 className="display-5 custom-jakarta fw-extra-bold mb-0">
                                Where music and magic unite for unforgettable experiences
                            </h1>
                            <ButtonCustom className={"gap-2 btn-gradient mt-4 mt-lg-40 mt-xxl-60"} link={"/home-1/#ticket"}>
